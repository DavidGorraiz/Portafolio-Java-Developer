...
public class AuditRoleListener {

    private RoleEntity currentValue;

    @PostLoad
    public void postLoad(RoleEntity role) {
        System.out.println("POST LOAD");
        this.currentValue = SerializationUtils.clone(role);
    }

    @PostPersist
    @PostUpdate
    public void onPostPersist(RoleEntity entity) {
    ...
    @PreRemove
    public void onPreDelete(RoleEntity entity) {
